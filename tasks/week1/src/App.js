    ...
    return (
      <div className="App">
        ...
        <Greet name="About" heroName="Page">
          <p>In this page you can find on Subscribe button. By clicking that button, you can see the thank you note wriiten by us. One increment button is also there for counting purpose. And </p>
        </Greet>
